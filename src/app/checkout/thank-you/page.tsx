  ...
  useEffect(() => {
    ...
    const processPage = async () => {
      ...
      try {
        ...
        const effectiveUserId = currentUser?.uid || (auth.currentUser ? auth.currentUser.uid : null) || (typeof window !== 'undefined' ? localStorage.getItem('fixbro_user_uid') : null) || undefined;

...
export async function generateMetadata(
  ...
  const title = replacePlaceholders(categoryData.metaTitle || seoSettings.cityCategoryPageTitlePattern, placeholderData) || `${categoryData.name} in ${cityData.name} | FixBro`;
  const description = replacePlaceholders(categoryData.metaDescription || seoSettings.cityCategoryPageDescriptionPattern, placeholderData) || `Book trusted ${categoryData.name} services in ${cityData.name} with FixBro.`;
  ...
  return {
    ...
    alternates: {
      canonical: `/${citySlug}/category/${categorySlug}`,
    },
    openGraph: {
      title: title,
      description: description,

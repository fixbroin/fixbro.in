...
export async function generateMetadata(
  ...
  const title = replacePlaceholders(categoryData.metaTitle || seoSettings.areaCategoryPageTitlePattern, placeholderData) || `${categoryData.name} in ${areaData.name}, ${cityData.name} | FixBro`;
  const description = replacePlaceholders(categoryData.metaDescription || seoSettings.areaCategoryPageDescriptionPattern, placeholderData) || `Expert ${categoryData.name} services in ${areaData.name}, ${cityData.name}. Reliable and professional home services by FixBro.`;
  ...
  return {
    ...
    alternates: {
      canonical: `/${citySlug}/${areaSlug}/${categorySlug}`,
    },
    openGraph: {
      title: title,
      description: description,

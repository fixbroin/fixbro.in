...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert Local SEO copywriter for a home services company called "FixBro". Your task is to generate highly aggressive, intent-driven content and SEO metadata for a specific service to rank #1 on Google.

...
const GenerateCategorySeoOutputSchema = z.object({
  ...
  seo_title: z.string().describe("An SEO-optimized meta title, under 60 characters. Format: '{{categoryName}} Services | Book Online | FixBro'"),
...
2.  **seo_title**: A meta title (under 60 chars) with the format: "{{categoryName}} Services | Book Online | FixBro".

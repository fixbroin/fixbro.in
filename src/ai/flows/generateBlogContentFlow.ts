...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert Local SEO copywriter for a home services company called "FixBro" based in Bangalore. Your goal is to write a blog post that ranks #1 on Google for home services in Bangalore.
...
1. **content**: Write a masterpiece of at least 600 words. Use an authoritative yet helpful tone.
   ...
   - Structure:
     - <h2><strong>Introduction</strong>: Why FixBro provides the best {{title}} in Bangalore.
     ...
     - <h2><strong>Why Choose FixBro?</strong>: Highlight 30-minute doorstep service.
     ...
     - <h2><strong>Conclusion</strong>: Call to action to book FixBro for {{categoryName}}, Plumbing, Electrical, etc.
   - **Keywords Footer**: An <h2> header 'Local Search Keywords' with a single <p> containing: "{{title}}, best home services Bangalore, {{categoryName}} near me Indiranagar, top-rated professional {{categoryName}} Koramangala, FixBro Bangalore, affordable home maintenance Whitefield".

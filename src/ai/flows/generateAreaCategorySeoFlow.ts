...
3. **Intent Keywords**: Include "near me" later in the title, like "{{categoryName}} in {{areaName}} | {{categoryName}} Near Me".
4. **No Filler**: Eliminate fluffy marketing adjectives from the beginning of strings.
...
5.  **seo_content**: A 200-300 word professional, engaging bio. It must include the primary keyword multiple times, describe the quality of service, mention {{areaName}} landmarks or vibes, and end with a strong reason to book via FixBro. Use HTML tags like <p>, <strong>, and <br> for formatting.
6.  **faqs**: Generate 3-5 Frequently Asked Questions that residents of {{areaName}} would ask about {{categoryName}} services. Answers should be helpful, include the locality name, and mention why FixBro is the best choice.
